...
test('find matching opening bracket', () => {
    ...
    matchingBracket = decode.findMatchingOpeningBracket(input, 33);
    expect(matchingBracket).toBe(14);

    matchingBracket = decode.findMatchingOpeningBracket(input, 45);
    expect(matchingBracket).toBe(43);

    matchingBracket = decode.findMatchingOpeningBracket(input, 48);
...
test('find matching closing bracket', () => {
    ...
    matchingBracket = decode.findMatchingClosingBracket(input, 14);
    expect(matchingBracket).toBe(33);

    matchingBracket = decode.findMatchingClosingBracket(input, 43);
    expect(matchingBracket).toBe(45);

    matchingBracket = decode.findMatchingClosingBracket(input, 8);
...
test('decode peterish string to "Hello World!"', () => {
    ...
    const output = decode.decode(input);
